                ...
                dbc.Col([
                    html.A(
                        dbc.Row(
                            [
                                ...
                                dbc.Col(dbc.NavbarBrand(" AssureNext App ", className="ml-1"), className="col-md-2")
                            ],
                            align = "start",
                            no_gutters = True,
                    ...
                    dbc.Nav(
                        [
                            ...
                            dbc.NavItem(dbc.NavLink("Previsões", href = "/paginas/forecast"), style = constant.NAVITEM_STYLE),
                            dbc.NavItem(dbc.NavLink("Insights", href = "/paginas/insights"), style=constant.NAVITEM_STYLE),
                        ], 
                        className = "h-100", 
                        navbar = True,
                        pills = True,
